...
if __name__ == '__main__':
    ...
    parser.add_argument('--ref_audio', type=str, default='./sample/Vĩnh (nam miền Nam).wav', help='Path to reference audio')
    parser.add_argument('--output_path', type=str, default='encoded_reference.pt', help='Path to save the output codes')
    args = parser.parse_args()
    main(ref_audio_path=args.ref_audio, output_path=args.output_path)